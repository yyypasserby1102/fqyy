...
export const masteryTransformationConfigs: MasteryChoiceDefinition[] = [
  ...
  ...buildApprovedRuntimeTransformations(),
  {
    ...
    lore: "Different rack swords focus the strongest threat with heavier cuts, but abandon their pack-clearing assignments.",
    kind: "transformation",
  ...
  },
  {
    id: "sword-bloom",
    name: "Sword Bloom",
    lore: "Each physical sword creates disposable shades for other enemies, but its own outbound cut is weaker.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 3,
    exclusivityGroup: "yujian-jue:rank-3"
  },
  {
    ...
    lore: "Most damage moves to the physical return path, so catching a sword early sacrifices the unfinished cut.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 3,
    exclusivityGroup: "yujian-jue:rank-3"
  ...
  {
    id: "still-sword-edge",
    name: "Still-Sword Edge",
    lore: "Resting swords charge a stronger launch, but every physical return takes longer.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 6,
  ...
  {
    id: "linked-sword-catch",
    name: "Linked Sword Catch",
    lore: "Catching a returning sword early readies the next launch immediately; a missed catch gives no acceleration.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 6,
    exclusivityGroup: "yujian-jue:rank-6"
  ...
  {
    id: "four-symbols-together",
    name: "Four Symbols Together",
    lore: "A full rack launches all four physical swords together, then cannot launch again until the rack is whole.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 6,
    exclusivityGroup: "yujian-jue:rank-6"
  ...
  {
    id: "heavenly-sword-crown",
    name: "Heavenly Sword Crown",
    lore: "One sword remains overhead as support, reducing the active rack from four swords to three.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 9,
  ...
  {
    id: "three-enclosure-sword-domain",
    name: "Three-Enclosure Sword Domain",
    lore: "Player and airborne swords form visible cutting lines; catching a sword shrinks the domain.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 9,
    exclusivityGroup: "yujian-jue:rank-9"
  ...
  {
    id: "void-step-recall",
    name: "Void-Step Recall",
    lore: "Evade bends all airborne sword paths home without creating another sword, but commits Evade to recall rather than offense.",
    kind: "transformation",
    requiredGongfaIds: ["yujian-jue"],
    milestoneRank: 9,
    exclusivityGroup: "yujian-jue:rank-9"
  ...
  {
    id: "heaven-splitting-long-edge",
    name: "Heaven-Splitting Long Edge",
    lore: "Movement lays long, narrow cuts parallel to the route instead of crosswise cuts.",
    kind: "transformation",
  ...
  {
    id: "golden-gale-crosscut",
    name: "Golden Gale Crosscut",
    lore: "Movement lays much wider crosscuts, but the distance between cuts increases.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 3,
    exclusivityGroup: "jinfeng-gong:rank-3"
  },
  {
    id: "crescent-wake",
    name: "Crescent Wake",
    lore: "Cuts appear behind the route after a delay and strike harder, leaving the front unprotected.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 3,
    exclusivityGroup: "jinfeng-gong:rank-3"
  ...
  {
    id: "unbroken-continuance",
    name: "Unbroken Continuance",
    lore: "Brief stops no longer break Momentum, but its maximum is permanently lower.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 6,
  ...
  {
    id: "borrowed-turn-edge",
    name: "Borrowed-Turn Edge",
    lore: "At full Momentum, one sharp reversal is allowed by immediately spending half of it.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 6,
    exclusivityGroup: "jinfeng-gong:rank-6"
  },
  {
    id: "gale-rupture",
    name: "Gale Rupture",
    lore: "Full Momentum ruptures into a ground crosscut and empties it; ordinary route cuts become shorter.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 6,
    exclusivityGroup: "jinfeng-gong:rank-6"
  ...
  {
    id: "one-line-to-horizon",
    name: "One Line to Horizon",
    lore: "A long strictly straight run upgrades route cuts into screen-wide ground lines.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 9,
  ...
  {
    id: "returning-dragon-edge",
    name: "Returning Dragon Edge",
    lore: "Gradual curves preserve Momentum, but maximum Momentum and cut length are reduced.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 9,
    exclusivityGroup: "jinfeng-gong:rank-9"
  ...
  {
    id: "formation-breaking-gale-step",
    name: "Formation-Breaking Gale Step",
    lore: "Evade cuts the ground at both departure and arrival, then spends half of current Momentum.",
    kind: "transformation",
    requiredGongfaIds: ["jinfeng-gong"],
    milestoneRank: 9,
    exclusivityGroup: "jinfeng-gong:rank-9"
