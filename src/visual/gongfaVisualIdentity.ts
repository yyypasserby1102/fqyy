...
export const gongfaVisualIdentities: Record<GongfaId, GongfaVisualIdentity> = {
  ...
  "green-vine-art": { motifId: "verdant-knot", label: "Two-polarity tension cable", geometry: "roots", accent: 0x72cf75, secondary: 0xcaf59d, spokes: 2, trailStyle: "contracting polygon edges" },
  ...
  "ironwood-wave-form": { motifId: "ironwood-rampart", label: "Physical ironwood rampart", geometry: "rings", accent: 0x548f56, secondary: 0xc3b477, spokes: 4, trailStyle: "solid timber beams and open corners" },
  ...
  "mist-wraith-canon": { motifId: "finite-funeral-procession", label: "Ranked corpse-soul procession", geometry: "wraiths", accent: 0x75d9ed, secondary: 0xe5fbff, spokes: 4, trailStyle: "boundary-crossing funeral roads" },
